...
class TestValidatePath:
    ...
    async def test_item_file(self, provider, mock_time):
        ...
        aiohttpretty.register_json_uri(
            'GET',
            'https://test.sample.nii.ac.jp/api/index/?action=browsing&q=100',
...
class TestMetadata:
    ...
    async def test_root_metadata(self, provider, monkeypatch):
        ...
        assert index_metadata.extra['weko_web_url'] == 'https://test.sample.nii.ac.jp/search?action=browsing&q=101'
    ...
    async def test_sub_item_metadata(self, provider, monkeypatch):
        ...
        aiohttpretty.register_json_uri(
            'GET',
            'https://test.sample.nii.ac.jp/api/index/?action=browsing&q=101',
